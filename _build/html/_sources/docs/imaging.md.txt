...
- `EXPERIMENTAL_STRATEGY_AND_DATA_SUBTYPES` (ExperimentalStrategyAndDataSubtypes) - **Required**
...
- `DE_IDENTIFICATION_METHOD_TYPE` (DeIdentificationMethodType) - **Required**
  - De-identification Method Type
- `DE_IDENTIFICATION_METHOD_DESCRIPTION` (string) - Optional
...
- `DE_IDENTIFICATION_SOFTWARE` (string) - Optional
...
- `IMAGING_PROTOCOL` (string) - Optional
...
- `STAINING_METHOD` (StainingMethod) - **Required**
...
- `HAS_SLIDE_LABEL` (boolean) - **Required**
  - Does the image contain a slide label
- `SLIDE_LABEL_REDACTED` (boolean) - Optional
  - Have identifiers including dates been masked in the label image
- `DE_IDENTIFIED` (boolean) - **Required**
