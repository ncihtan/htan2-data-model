...
This script was used for testing the process of pushing annotations
to Synapse entities during development and validation of the HTAN
data model integration with Synapse.
"""
...
def main():
    ...
    file_mappings = {"test_vital_status_deceased.json": "syn69060694"}
