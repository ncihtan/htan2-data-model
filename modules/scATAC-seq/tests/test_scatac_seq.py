...
LEVEL_REQUIRED = {
    "scATACLevel1": [
        ...
        "LIBRARY_CONSTRUCTION_METHOD", "REVERSE_TRANSCRIPTION_PRIMER", "SPIKE_IN",
    ...
    "scATACLevel2": [
        ...
        "MEDIAN_GENES_PER_CELL", "NUMBER_OF_CELLS", "MEDIAN_PASSING_READS_PERCENTAGE",
        "DUPLICATE_READ_PAIRS", "CHIMERIC_READ_PAIRS", "UNMAPPED_READ_PAIRS",
        "LOW_MAP_Q", "MITOCHONDRIAL_READ_PAIRS", "PASSED_FILTERS",
    ],
    "scATACLevel3and4": [
        "FILE_FORMAT", "FILENAME",
