...
# Generation date: 2026-03-04T12:07:41
# Schema: WES
#
...
class BulkWESLevel1HTANDATAFILEID(BaseSequencingLevel1AttributesHTANDATAFILEID):
    pass
...
class BulkWESLevel2HTANDATAFILEID(BaseSequencingLevel2AttributesHTANDATAFILEID):
    pass
...
class BulkWESLevel3HTANDATAFILEID(BaseSequencingLevel3AttributesHTANDATAFILEID):
    pass
...
@dataclass(repr=False)
class BulkWESLevel1(BaseSequencingLevel1Attributes):
    """
...
@dataclass(repr=False)
class BulkWESLevel2(BaseSequencingLevel2Attributes):
    """
...
@dataclass(repr=False)
class BulkWESLevel3(BaseSequencingLevel3Attributes):
    """
...
slots.bulkWESLevel1__FILE_FORMAT = Slot(
    uri=HTAN.FILE_FORMAT,
    name="bulkWESLevel1__FILE_FORMAT",
    curie=HTAN.curie("FILE_FORMAT"),
    model_uri=HTAN.bulkWESLevel1__FILE_FORMAT,
    domain=None,
    range=str,
    pattern=re.compile(r"^(fastq|fastq\.gz)$"),
)

slots.bulkWESLevel1__FILENAME = Slot(
    uri=HTAN.FILENAME,
    name="bulkWESLevel1__FILENAME",
    curie=HTAN.curie("FILENAME"),
    model_uri=HTAN.bulkWESLevel1__FILENAME,
    domain=None,
    range=str,
...
slots.bulkWESLevel2__FILE_FORMAT = Slot(
    uri=HTAN.FILE_FORMAT,
    name="bulkWESLevel2__FILE_FORMAT",
    curie=HTAN.curie("FILE_FORMAT"),
    model_uri=HTAN.bulkWESLevel2__FILE_FORMAT,
    domain=None,
    range=str,
    pattern=re.compile(r"^(bam|cram)$"),
)

slots.bulkWESLevel2__FILENAME = Slot(
    uri=HTAN.FILENAME,
    name="bulkWESLevel2__FILENAME",
    curie=HTAN.curie("FILENAME"),
    model_uri=HTAN.bulkWESLevel2__FILENAME,
    domain=None,
    range=str,
    pattern=re.compile(r"^.+\.(bam|cram)$"),
)
...
slots.bulkWESLevel3__FILE_FORMAT = Slot(
    uri=HTAN.FILE_FORMAT,
    name="bulkWESLevel3__FILE_FORMAT",
    curie=HTAN.curie("FILE_FORMAT"),
    model_uri=HTAN.bulkWESLevel3__FILE_FORMAT,
    domain=None,
    range=str,
    pattern=re.compile(r"^(vcf|vcf\.gz)$"),
)

slots.bulkWESLevel3__FILENAME = Slot(
    uri=HTAN.FILENAME,
    name="bulkWESLevel3__FILENAME",
    curie=HTAN.curie("FILENAME"),
    model_uri=HTAN.bulkWESLevel3__FILENAME,
    domain=None,
    range=str,
