...
| `PANEL_SYNAPSE_ID` | string | No | `^syn\d+$` | Synapse ID of the completed spatial_omics_panel template |
...
| `PROTOCOL_LINK` | string | No | `^(?:(?:https?)://)(?:\S+(?::\S*)?@)?(?:(?!(?:10|127)(?:\.\d{1,3}){3})(?!(?:169\.254|192\.168)(?:\.\d{1,3}){2})(?!172\.(?:1[6-9]|2\d|3[0-1])(?:\.\d{1,3}){2})(?:[1-9]\d?|1\d\d|2[01]\d|22[0-3])(?:\.(?:1?\d{1,2}|2[0-4]\d|25[0-5])){2}(?:\.(?:[1-9]\d?|1\d\d|2[0-4]\d|25[0-4]))|(?:(?:[a-z\u00a1-\uffff0-9]-*)*[a-z\u00a1-\uffff0-9]+)(?:\.(?:[a-z\u00a1-\uffff0-9]-*)*[a-z\u00a1-\uffff0-9]+)*(?:\.(?:[a-z\u00a1-\uffff]{2,}))\.?)(?::\d{2,5})?(?:[/?#]\S*)?$` | URL to protocol documentation |
...
| `SAME_SECTION_IMAGING_ID` | string | No | `^(HTA([1-9]|1[0-6]))_((EXT)?([0-9]\d*|0000))_([0-9]\d*|0000)$` | HTAN ID of data file that represents same section imaging |
...
| Attribute | Type | Required | Pattern | Description |
|-----------|------|----------|---------|-------------|
| `GENE_ID` | string | Yes | `^(ENSG\d+|\d+)$` | Stable Ensembl gene identifier (e.g., ENSG00000214114, ENSG00000121879). String matching ENSG\\d+ or digits |
| `GENE_SYMBOL` | string | Yes | `^[A-Za-z0-9_\-]+(@)?$` | HGNC-approved Gene symbol (e.g., MYC, PIK3C) |
| `HGNC_VERSION` | string | Yes | `^\d{4}-\d{2}-\d{2}$` | Version of the HGNC used, indicated with the date of the HGNC reference (e.g., 2025-08-01) |
| `HTAN_PANEL_ID` | string | Yes | `^(HTA([1-9]|1[0-6]))_((EXT)?([0-9]\d*|0000))_([0-9]\d*|0000)$` | Unique identifier for the panel |
