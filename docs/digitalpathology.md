...
| Attribute | Type | Required | Description |
|-----------|------|----------|-------------|
| `FILE_FORMAT` | string | Yes | Format of the imaging file. Must be compatible with Bio-Formats or OpenSlide Python. OME-TIFF files use extensions .ome.tif, .ome.tiff, .ome.tf2, .ome.tf8, or .ome.btf. NDPIS (Hamamatsu) use .ndpi. |
| `FILENAME` | string | Yes | Name of the file. Must end with an extension matching the FILE_FORMAT (.ome.tif, .ome.tiff, .ome.tf2, .ome.tf8, .ome.btf for ome-tiff; .tiff or .tif for tiff; .qptiff for qptiff; .svs for svs; .ndpi for ndpi) |
| `HAS_ANNOTATIONS` | boolean | Yes | Does the image contain annotations |
| `ANNOTATION_TYPE` | [AnnotationType](enums.md#annotationtype) | Conditional: Required when HAS_ANNOTATIONS is true | Required when HAS_ANNOTATIONS is true |
| `EXPERIMENTAL_STRATEGY_AND_DATA_SUBTYPES` | [ExperimentalStrategyAndDataSubtypes](enums.md#experimentalstrategyanddatasubtypes) | Yes | What is the experimental strategy used for the study (or what type of data subtypes exist in the study)? Per RFC, the only valid value for imaging data types is "Pathological". |
| `DE_IDENTIFICATION_METHOD_TYPE` | [DeIdentificationMethodType](enums.md#deidentificationmethodtype) | Yes | De-identification Method Type |
