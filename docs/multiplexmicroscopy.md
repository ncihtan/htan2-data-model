...
| `IMAGING_ASSAY_TYPE` | [ImagingAssayType](enums.md#imagingassaytype) | Yes | Type of imaging assay |
...
| `MATRIX_TYPE` | [MatrixTypeEnum](enums.md#matrixtypeenum) | Yes | Type of feature matrix (raw counts, normalized, etc.) |
...
| `METAL_ISOTOPE_ELEMENT_ABBREVIATION` | [MetalIsotopeElement](enums.md#metalisotopeelement) | No | Element abbreviation |
