...
--     * Slot: id Description: 
--     * Slot: COMPONENT Description: Category of metadata (e.g. Diagnosis, Biospecimen, scRNA-seq Level 1, etc.); provide the same one for all items/rows. (No CRDC Standard Available)
--     * Slot: HTAN_PARTICIPANT_ID Description: HTAN Identifier of the research participant (caDSR:HTAN-Specific) (No CRDC Standard Available)
...
--     * Slot: ClinicalData_id Description: Autocreated FK slot
...
--     * Slot: ClinicalData_id Description: Autocreated FK slot
--     * Slot: THERAPIES_id Description: Treatment information
...
CREATE TABLE "Diagnosis" (
	...
	"TISSUE_OR_ORGAN_OF_ORIGIN_UBERON_CODE" TEXT NOT NULL, 
...
CREATE TABLE "FollowUp" (
	...
	"PROGRESSION_OR_RECURRENCE_ANATOMIC_SITE_UBERON_CODE" TEXT, 
...
CREATE TABLE "Therapy" (
	...
	"THERAPY_ANATOMIC_SITE_UBERON_CODE" TEXT, 
...
CREATE TABLE "ClinicalData_THERAPIES" (
	...
	PRIMARY KEY ("ClinicalData_id", "THERAPIES_id"), 
	FOREIGN KEY("ClinicalData_id") REFERENCES "ClinicalData" (id), 
